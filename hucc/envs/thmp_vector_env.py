# This is a verbatim copy of gym's AsyncVectorEnv, but using torch
...
from gym.error import (AlreadyPendingCallError, ClosedEnvironmentError,
                       CustomSpaceError, NoAsyncCallError)
from gym.vector.utils import (CloudpickleWrapper, clear_mpi_env_vars,
                              concatenate, create_empty_array,
...
class TorchAsyncVectorEnv(VectorEnv):
